...
// Novo Orbi: interface redesenhada, mesma base funcional.
RELEASE_NOTES['1.0.0'] = [
  'Nova interface do Orbi',
  '',
  '• Visual novo em todas as telas: Analytics, Agenda, Gerenciar contas, Configurações e Ajuda viraram páginas no cabeçalho.',
  '• A janela ganhou barra de título própria, com minimizar, maximizar e fechar no cabeçalho.',
